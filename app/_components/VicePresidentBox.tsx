            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            className="text-md md:text-md font-bold text-gray-800 items-center justify-center flex md:text-center leading-[18px] md:leading-normal">{truncateString(vicePresident.full_name, 25)}</div>
                        <div
